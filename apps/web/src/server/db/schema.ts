...
// ── Better Auth OAuth provider tables (unprefixed, owned by the adapter) ─────
// Generated by `@better-auth/cli generate` for @better-auth/oauth-provider +
// the JWT plugin. Drizzle relations are intentionally omitted: the Better Auth
// adapter queries these tables directly and does not use drizzle relations.
...
// JWT plugin (auto-enabled by oauthProvider): signing key store for JWKS.

...
- AI task drafting — paste a client message, let Mistral (`mistral-small-latest`) extract actionable issues with title, description, label, and priority. Shift+V on any board, or the command palette.
...
- [tRPC](https://trpc.io)
- [Mistral](https://mistral.ai) — powers the AI task drafter (optional; set `MISTRAL_API_KEY` to enable)
